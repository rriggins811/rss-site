...
Senior Transition Roadmap is $297. It is one 60-minute strategy call with me. A personalized written plan you keep. 90 days of email support while you actually start executing the plan.
...
A real estate agent earns 2.5-3% of the sale price as commission, which aligns them with selling the house. Senior Transition Roadmap is $297 flat and earns nothing on the outcome. The plan we build together might recommend selling with an agent, holding and modifying for aging in place, exploring owner financing or a lease option, or some combination. Whichever path fits your family wins, and I am financially neutral on which one you pick. If you do decide to list with an agent, I can help you interview and vet them.
...
When the conversation needs structure: Senior Transition Roadmap is $297. One call, one plan, 90 days of support. Built for exactly the families this article describes.
