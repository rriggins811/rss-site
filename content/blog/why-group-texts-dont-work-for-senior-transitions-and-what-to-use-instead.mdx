...
howToSteps:
  ...
  - name: "Set up a daily check-in routine"
    text: "Whether you use the SeniorSafe app or a simple agreed-upon phone call, make it consistent. Every day, same time. The point is not the technology. It is the predictability. Silence becomes the alarm bell that drives action."
---
