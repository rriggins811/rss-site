...
Decide sell, rent or keep first. If the right answer is to sell, list with one vetted local agent and do the work. If someone pitches a way to spread the gain over several tax years, have a CPA and an attorney read it before anyone signs. Run the math before letting urgency drive the decision. The [sell, rent or keep guide](/sell-rent-or-keep-parents-house) walks through the choice.
