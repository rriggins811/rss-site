...
- [SeniorSafeApp](https://app.seniorsafeapp.com). The document vault, the daily check in, six one-tap contacts, medication reminders, and a companion for a parent who lives alone. My grandmother's phone has one app on it.
