 ...
 * guide is the lead magnet). The full Blueprint's value is the in-depth
...
export const GUIDE_PREVIEWS: Record<string, GuidePreview> = {
  ...
  "module-19": {
    ...
    points: [
      ...
      "Free help stays free: the strategy call, the SeniorSafeApp app for daily check-ins and AI guidance, and the daily content.",
