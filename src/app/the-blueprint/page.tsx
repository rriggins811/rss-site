...
const tiers: Tier[] = [
  ...
  },
  {
    ...
    blurb: "Call an agent today and they want the house listed by the weekend. That is the job. Talk to me before you are ready and nothing starts. When it is time, I find and vet the right agent and stay in it with you the whole way.",
    audience: "Families selling a parent's home who want a vetted agent and a second eye on the deal, whether that is this month or next year.",
    bullets: [
      "No three appointments, no three prices, nobody to tell no.",
      "The right local agent, hand picked and vetted for you.",
      "A second eye on every offer, contract, and repair call.",
      "If the right answer is do not sell yet, you hear that too.",
