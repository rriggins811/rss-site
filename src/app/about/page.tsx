...
// Moved to lib/reviews.ts on Aug 10 2026 so the homepage can render the same
// review from the same array. This page still owns the Review JSON-LD.
        ...
        <div className="mx-auto max-w-6xl px-6 py-20 grid gap-12 lg:grid-cols-2 items-center">
          ...
          <div>
            ...
            <div className="mt-6 space-y-5 text-ink/85 text-lg leading-relaxed">
              <p>
                I also built <strong>Hammock365</strong>, a family coordination app
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Button asChild>
                <Link href="/hammock365">See Hammock365</Link>
              </Button>
