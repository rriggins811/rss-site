...
const FREEGUIDE_FAQS: FAQItem[] = [
  ...
  {
    question: "Do I have to enter a credit card for Hammock365?",
    answer:
      "No. Hammock365 is free forever, and your Simple Blueprint signup sets up the free account automatically. There is no trial and no clock. If your family wants texts to everyone, family messages, the document vault, and Maggie every day, one paid plan is $14.99 a month or $140 a year, and you choose it inside the app. No charges unless you do.",
  },
  {
