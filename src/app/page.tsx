...
const paths: {
...
}[] = [
  {
    ...
    cta: { href: "https://blueprint.rigginsstrategicsolutions.com/pricing", label: "See what's inside", external: true },
  ...
  },
  {
    ...
    cta: { href: "https://blueprint.rigginsstrategicsolutions.com/pricing", label: "See Premium", external: true },
